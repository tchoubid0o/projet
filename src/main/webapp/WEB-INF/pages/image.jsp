<%@page import="hei.devweb.dao.UsersDao"%>
<%@page import="hei.devweb.dao.impl.UsersDaoImpl"%>
<%@page import="hei.devweb.metier.UsersManager"%>
	...
	<section class="width1000" style="margin-top: 35px;">
		...
		<div id="right">
			<div class="right_content">
				<span class="erreur">${erreurs['idUser']}</span> 
				<span class="erreur">${erreurs['commentContent']}</span> 
